...
document.addEventListener("DOMContentLoaded", function () {
    const closeBtn = document.getElementById("closeKivyApp");
    if (closeBtn) {
        closeBtn.addEventListener("click", function () {
            if (window.android && android.closePDFViewer) {
                android.closePDFViewer();
            }
        });
    }
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (openBtn) {
        // Override del comportamiento nativo
        openBtn.addEventListener("click", function () {
            if (window.android && android.requestPDFFile) {
                android.requestPDFFile();  // Llama a Android para abrir selector
            }
        });
    }
});
